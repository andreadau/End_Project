    ...
    <aside class="sidebar">
        <div class="dashboard_list">
            <ul>
                ...
                <li class="{{ Route::currentRouteName() === 'admin.index' ? 'active' : '' }}"><a href="{{ route('admin.index') }}"><i class="fas fa-home"></i> <span>Dashboard</span></a></li>
                <li class="{{ Route::currentRouteName() === 'admin.restaurants.index' ? 'active' : '' }}"><a href="{{ route('admin.restaurants.index') }}"><i class="fas fa-store"></i> <span>Restaurant</span></a></li>
                <li class="{{ Route::currentRouteName() === 'admin.types.index' ? 'active' : '' }}"><a href="{{ route('admin.types.index') }}"><i class="fas fa-utensils"></i> <span>Types</span></a></li>
                <li class="{{ Route::currentRouteName() === 'admin.dishes.index' ? 'active' : '' }}"><a id="dishes" href="{{ route('admin.dishes.index') }}"><i class="fas fa-pizza-slice"></i> <span>Dishes</span></a></li>
                <li class="{{ Route::currentRouteName() === 'admin.orders.index' ? 'active' : '' }}"><a href="{{ route('admin.orders.index') }}"><i class="fas fa-scroll"></i> <span>Orders</span></a></li>
